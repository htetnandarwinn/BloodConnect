...
<section class="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-10">
    <div class="w-full max-w-md rounded-3xl border border-gray-200 bg-white p-8 shadow-xl shadow-gray-100">
        <div class="text-center mb-8">
            ...
            <h2 class="mt-4 text-2xl font-black text-gray-900">Forgot Password</h2>
            <p class="mt-2 text-sm text-gray-500">Enter your email and we’ll send you an OTP to reset your password.</p>
        </div>
        ...
        <form method="post" action="/BloodConnect/public/forgot-password" class="space-y-5">
            <div>
                ...
                <?php if (!empty($errors['email'])): ?>
                    <p class="mt-2 text-sm font-semibold text-red-600"><?= htmlspecialchars($errors['email'], ENT_QUOTES) ?></p>
                <?php endif; ?>
            </div>
        ...
        <div class="mt-6 text-center">
            <a href="/BloodConnect/public/login" class="text-sm font-semibold text-red-600 hover:text-red-700">Back to login</a>
        </div>
    </div>
</section>