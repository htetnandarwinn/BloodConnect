...
<head>
    ...
    <title>BloodConnect — Search Donor</title>
    <style>
        body {
            margin: 0;
...
<body>
    ...
    <main class="page">
        <h1>Search Donors</h1>
        <p>Explore available blood donors in your area. Sign in or register to access full donor search and request details.</p>
        <a class="btn" href="<?= $basePath ?>/register">Register to continue</a>
    </main>
</body>
